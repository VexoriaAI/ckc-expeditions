...
// UPDATE: (CORREÇÃO DE IMPORT)
// Substitui STATIC_MAP_DATA por MAP_NODES (arquitetura de Nós).
// ==================================================================== */
...
const getCurrentBiomeKey = (nodeId) => {
    const node = MAP_NODES.find(n => n.id === nodeId); // Usa MAP_NODES
...
export const ExpeditionManager = {
    ...
    collectResources: function() {
        ...
        // (ATUALIZADO) Usa o ID do nó da posição
